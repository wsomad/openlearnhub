            ...
            <div className='px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12'>
                ...
                <div className='flex justify-center items-start mt-10 gap-6'>
                    ...
                    <div className='flex flex-col'>
                        <div className='p-6 border border-gray rounded-md max-w-md max-h-[450px] overflow-y-auto'>
                            ...
                            <p className='font-abhaya text-lg'>
                                ...
                                introduction to building web applications using
                                React and Redux. Perfect for both beginners and
                        ...
                        <div className='flex flex-col mt-5'>
                            ...
                            <div className='font-abhaya text-lg flex flex-row justify-center items-center mt-4'>
