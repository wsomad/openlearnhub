...
const ModalComponent: React.FC<ModalComponentProps> = ({
    ...
    const PreviewPanel = () => {
        ...
        if (lessonType === 'document') {
            if (!uploadedFile && !documentUrl) {
                return (
                    <div
                        className={`flex flex-col items-center justify-center h-full rounded-3xl border-2 border-dashed transition-colors ${
                            isDragging
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
            <div className='w-full max-w-[90%] h-[80vh] p-6 bg-white rounded-3xl'>
                <div className='flex h-full gap-6'>
                    ...
                    {/* Preview Section */}
                    <div className='w-1/2 bg-gray-50 p-6 rounded-3xl'>
                        <PreviewPanel />
                    </div>
                </div>
            </div>
