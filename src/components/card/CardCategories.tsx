            ...
            <div className="flex flex-row">
                ...
                <div className="filters pl-6 w-full lg:w-1/5">
                    <div className="filter mb-6">
                        <label className="block text-lg font-semibold">Course Type</label>
                        <div className="space-y-2 mt-2">
                            {['Web Development', 'Machine Learning', 'Mobile Development', 'Cybersecurity'].map(
                                (type) => (
                    ...
                    <div className="filter">
                        <label className="block text-lg font-semibold">Sort By</label>
                        <div className="space-y-2 mt-2">
                            {['newest', 'oldest', 'popular'].map((sortOption) => (
                                <label key={sortOption} className="flex items-center">
                                    <input
                                        type="radio"
                                        value={sortOption}
                                        checked={sortBy === sortOption}
                                        onChange={() => setSortBy(sortOption as 'newest' | 'oldest' | 'popular')}
                                        className="mr-2 leading-tight"
                                    />
                ...
                <div>
                    ...
                    <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                        {renderedCourse}
                    </div>
                </div>
            </div>
