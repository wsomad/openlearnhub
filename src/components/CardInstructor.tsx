...
const CardInstructor: React.FC<CardIntrustorProps> = ({
    ...
    return (
        <div
            className="bg-white border border-gray overflow-hidden shadow-sm hover:shadow-md transition-shadow relative"
        >
            ...
            <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-5 mb-4">
                    ...
                    <div>
                        <p className="text-gray-500 text-sm font-abhaya">Status</p>
                        <p className="text-lg font-semibold font-abhaya">
